...
import { inferEntries, inferExportType, extractExportFilenames, getEntrypointPaths, getEntrypointFilenames } from '../../src/entries'

describe('inferEntries', () => {
  it('loads files from rootDir', () => {
    expect(inferEntries({ exports: './dist/index.mjs' })).to.deep.equal({
      emitCJS: undefined,
      declaration: undefined,
      entries: [{ input: resolve(process.cwd(), 'src/index') }]
    })
  })
